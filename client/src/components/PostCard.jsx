...
const PostCard = ({post}) => {
  return (
    <div className='group relative w-full border h-[400px] border-teal-500 hover:border-2
     overflow-hidden rounded-lg sm:w-[360px]  transition-all  '>
      <Link to={`/post/${post.slug}`} >
         <img src={post.image} alt="post image" className="h-[260px] w-full object-cover
